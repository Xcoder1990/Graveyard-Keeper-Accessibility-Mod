...
namespace ConfigurationManager.Utilities
{
    internal static class Utils
    {
        ...
        public static string GetWebsite(BaseUnityPlugin bepInPlugin)
        {
            ...
            try
            {
                var fileName = bepInPlugin.Info.Location;
            ...
            {
                ConfigurationManagerPlugin.Logger.LogWarning($"Failed to get URI for {bepInPlugin.Info?.Metadata?.Name} - {e.Message}");
                return null;
            }
        }
        ...
        public static void OpenWebsite(string url)
        {
            ...
            {
                ConfigurationManagerPlugin.Logger.Log(LogLevel.Message | LogLevel.Warning, $"Failed to open URL {url}\nCause: {ex.Message}");
            }
        }
